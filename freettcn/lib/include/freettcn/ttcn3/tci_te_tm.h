 ...
 * 
 * @remarks Shall only be called after either the control part of the module or a test case has been started using
 ...
 * 
 * @remarks Shall only be called after either the control part of the module or a test cases has been started
 ...
 * 
 * @remarks Shall only be called when the module execution has been started using the
 ...
 * provide a TTCN-3 value, the distinct @c null value shall be returned.
 * 
 * @remarks This operation shall be called whenever the TE needs to access the value of a module
 ...
 * 
 * @remarks Can be called at any time by the TE to indicate an unrecoverable error situation. This error
