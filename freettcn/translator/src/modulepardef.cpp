...
/** 
 * @brief CModuleParDef class constructor.
 * 
 ...
 */
TTCN3::CModuleParDef::CModuleParDef(CFile &f, const YYLTYPE &loc, CIdentifier &id, CModule &mod):
...
/**
 * @brief CModuleParDef class destructor.
 */
TTCN3::CModuleParDef::~CModuleParDef()
{
}
