...
/** 
 * @brief CGroupDef class constructor.
 * 
 ...
 */
TTCN3::CGroupDef::CGroupDef(CFile &f, const YYLTYPE &loc, CIdentifier &id, CModule &mod):
  CDefinition(f, loc, id, mod)
{
}

/**
 * @brief CGroupDef class destructor.
 */
TTCN3::CGroupDef::~CGroupDef()
{
}
