...
/** 
 * @brief CTestcaseDef class constructor.
 * 
 ...
 */
TTCN3::CTestcaseDef::CTestcaseDef(CFile &f, const YYLTYPE &loc, CIdentifier &id, CModule &mod):
...
/**
 * @brief CTestcaseDef class destructor.
 */
TTCN3::CTestcaseDef::~CTestcaseDef()
{
}
