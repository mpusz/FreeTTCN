...
/** 
 * @brief CConstDef class constructor.
 * 
 ...
 */
TTCN3::CConstDef::CConstDef(CFile &f, const YYLTYPE &loc, CIdentifier &id, CModule &mod):
  CDefinition(f, loc, id, mod)
{
}

/**
 * @brief CConstDef destructor.
 */
TTCN3::CConstDef::~CConstDef()
{
}
