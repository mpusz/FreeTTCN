...
/** 
 * @brief CSignatureDef class constructor.
 * 
 ...
 */
TTCN3::CSignatureDef::CSignatureDef(CFile &f, const YYLTYPE &loc, CIdentifier &id, CModule &mod):
...
/**
 * @brief CSignatureDef class destructor.
 */
TTCN3::CSignatureDef::~CSignatureDef()
{
}
